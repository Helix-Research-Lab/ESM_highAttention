...
with open('/oak/stanford/groups/rbaltman/gnayar/pathways/data/prot_highAttnSite_minThree.pkl', 'rb') as file:
    prot_highAttend = pickle.load(file)
with open('/oak/stanford/groups/rbaltman/gnayar/pathways/data/prot_activeSite.pkl', 'rb') as file:
...
counter = 0
pdb_dir = '/oak/stanford/groups/rbaltman/alphafoldDB/human_proteome'
dist_spatial = []
overlap_ha = set()
num_prot_anal = 0
for prot in prot_highAttend:
    ...
    if (prot in prot_activeSite):
        ...
        pdb_file = '{}/AF-{}-F1-model_v4.pdb.gz'.format(pdb_dir, prot)
...
with open('/oak/stanford/groups/rbaltman/gnayar/pathways/data/spatial_HA_active_dist.pkl', 'wb') as file:
    pickle.dump(dist_spatial,file)
with open('/oak/stanford/groups/rbaltman/gnayar/pathways/data/spatial_HA_active_overlapProt.pkl', 'wb') as file:
    pickle.dump(overlap_ha,file)
